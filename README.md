...
<div align="center">
  <blockquote>
    <p><em>"In the universe of code, I am both the explorer and the creator, constantly pushing the boundaries of what's possible."</em></p>
  </blockquote>
</div>
  ...
  <table>
    ...
    <tr>
      ...
      <td>
        ...
        National Institute of Software and Information Technology, Delhi, India
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        ...
        Kendriya Vidyalaya RRC Fatehgarh, Fatehgarh, India
      </td>
    </tr>
  </table>
</div>
  ...
  <table>
    <tr>
      ...
      <td>
        ...
        XZECT LABS PVT LTD (Remote)<br>
        <ul>
          <li>Worked on multiple projects, including an AI chatbot tailored to business needs</li>
          <li>Improved website performance, reducing load times through optimized front-end techniques</li>
          <li>Conducted code reviews to improve quality and maintainability</li>
          <li>Utilized Git for version control to manage and track code changes effectively</li>
        </ul>
      </td>
    </tr>
  </table>
